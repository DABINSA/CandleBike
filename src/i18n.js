...
const DICT = {
  ko: {
    ...
    gasBtn: '가속<br/>▶',
    restartBtn: '↻ 재시작',
    hintTouch: '앞들기 / 앞숙임으로 자세 잡고 · 가속▶ 전진 · ⤴점프 · 공중에서 앞들기=백플립',
    hintKeys: '↑가속 · ←앞들기(윌리) · →앞숙임 · Space 점프 · ↓브레이크 · 공중 ←=백플립',
  ...
  en: {
    ...
    gasBtn: 'Gas<br/>▶',
    restartBtn: '↻ Restart',
    hintTouch: 'Lift / Nose to balance · Gas▶ to go · ⤴Jump · in air Lift=backflip',
    hintKeys: '↑Gas · ←Lift(wheelie) · →Nose · Space Jump · ↓Brake · air ←=backflip',

...
const DICT = {
  ko: {
    ...
    shareReward: '🎁 친구에게 공유하고 아이템 받기',
    sharePickTitle: '받을 아이템을 골라 친구에게 공유하세요',
  ...
  en: {
    ...
    shareReward: '🎁 Share with friends to get an item',
    sharePickTitle: 'Pick your reward, then share with friends',

...
const DICT = {
  ko: {
    ...
    jumpBtn: '⤴<br/>점프',
    gasBtn: '가속<br/>▶',
    hintTouch: '◀뒤로(앞숙임) · ⤴점프 · 가속▶(앞들림) — 둘을 조절해 균형! · 공중 가속=백플립',
    hintKeys: '← 뒤로/앞숙임 · Space 점프 · → 가속/앞들림 — 균형 잡기 · 공중 →=백플립',
  ...
  en: {
    ...
    jumpBtn: '⤴<br/>Jump',
    gasBtn: 'Gas<br/>▶',
    hintTouch: '◀Reverse (nose down) · ⤴Jump · Gas▶ (wheelie) — balance both! · air Gas=backflip',
    hintKeys: '← Reverse/nose-down · Space Jump · → Gas/wheelie — balance · air →=backflip',

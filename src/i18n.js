...
const DICT = {
  ko: {
    ...
    randomChip: '랜덤',
    randomTitle: '랜덤 추천 코스',
    randomSub: '마음에 드는 코스로 출발 · 마음에 안 들면 다시 돌리기',
    randomRolling: '코스 고르는 중…',
    randomReroll: '다시 돌리기',
    randomTagNew: '🆕 아무도 안 달린 코스',
    randomTagBeat: '🏆 1위 노려볼 만한 코스',
    randomWhyNew: '완주하면 당신이 바로 1위 🏆',
    randomWhyBeat: (sec) => `현재 1위 ${sec}초 — 깰 수 있어요 🔥`,
    randomFail: '후보를 찾지 못했어요. 잠시 후 다시 시도해 주세요.',
    viewLeaderboard: '🏆 종목별 1위 보기',
    championsTitle: '🏆 종목별 1위',
    championsSub: '종목마다 현재 1위 · 최신 달성순 · 도전해서 1위를 뺏어보세요!',
    challenge: '도전',
    myRankFirst: '내 1위 👑',
    myRankN: (n) => `내 ${n}위`,
    myRankNone: '기록 없음',
    ...
    hintTouch: '오른손 가속▶ · 왼손 점프·앞숙임·앞들기(가속 안 누르면 뒤로)<br/>🔄 공중에서 앞들기 = 백플립 → 강력 부스터!',
    hintKeys: '↑가속 · ←앞들기(윌리) · →앞숙임 · ↓뒤로(후진) · Space 점프<br/>🔄 공중에서 ← = 백플립 → 강력 부스터!',
    ...
    reviveSkip: '그만하기',
    brand: '📈🏍️ 캔들라이더',
    share: '📲 공유하고<br/>금화 10 받기',
    saveImg: '🖼️ 결과 이미지 저장',
    leaderboardTitle: (s) => (s ? `🏆 ${s} 순위` : '🏆 전체 순위'),
    weeklyNote: '이번 주 순위 · 매주 월 04:00 리셋 · 다음 리셋',
    adFoot: '광고 문의: contact@2nt4soft.com',
    affiliateNote: '본 서비스는 각 기업과 무관하며 후원·제휴 관계가 아닙니다. 시세는 오락용 참고 자료입니다.',
    allTimeTop: '역대 1위 (이 종목 최고기록)',
    dayUnit: '일',
  ...
  en: {
    ...
    randomChip: 'Random',
    randomTitle: 'Random picks',
    randomSub: 'Tap a course to start · roll again if not feeling it',
    randomRolling: 'Picking a course…',
    randomReroll: 'Roll again',
    randomTagNew: '🆕 Untouched course',
    randomTagBeat: '🏆 Beatable #1',
    randomWhyNew: 'Finish it and you take 1st 🏆',
    randomWhyBeat: (sec) => `Current #1 is ${sec}s — you can beat it 🔥`,
    randomFail: "Couldn't find candidates. Please try again shortly.",
    viewLeaderboard: '🏆 Top by stock',
    championsTitle: '🏆 Top by stock',
    championsSub: 'Current #1 per stock · newest first · challenge to steal the crown!',
    challenge: 'Race',
    myRankFirst: 'You #1 👑',
    myRankN: (n) => `You #${n}`,
    myRankNone: 'No record',
    agoNow: 'just now',
    agoMin: (m) => `${m}m ago`,
    agoHour: (h) => `${h}h ago`,
    ...
    hintTouch: 'Right: Gas▶ · Left: Jump·Nose·Lift (no gas = reverse)<br/>🔄 Lift in air = backflip → big boost!',
    hintKeys: '↑Gas · ←Lift(wheelie) · →Nose · ↓Back · Space Jump<br/>🔄 ← in air = backflip → big boost!',
    ...
    brand: '📈🏍️ CandleRider',
    share: '📲 Share<br/>for +10 coins',
    saveImg: '🖼️ Save image',
    leaderboardTitle: (s) => (s ? `🏆 ${s} Ranking` : '🏆 Leaderboard'),
    weeklyNote: 'This week · resets Mon 04:00 · next reset in',
    adFoot: 'Advertising: contact@2nt4soft.com',
    affiliateNote: 'Not affiliated with or endorsed by any of the companies shown. Prices are for entertainment reference only.',
    allTimeTop: 'All-time #1 (course record)',
    dayUnit: 'd',
